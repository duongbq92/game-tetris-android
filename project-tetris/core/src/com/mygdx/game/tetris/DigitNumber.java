...
public class DigitNumber
{
	...
	private void init(int num_digits, int x, int y)
	{
		...
		fontCache = new BitmapFont(Gdx.files.internal("data/BlackDigit45.fnt"),
				Gdx.files.internal("data/BlackDigit45.png"), true);
	...
	public void ChangeNumberTo(int new_number)
	{
		...
		this.changeValue = (newNumber - this.currentNumber) / 50 + 1;// plus one
																		// to
																		// prevent
																		// zero
																		// value
	...
	public void Draw(SpriteBatch batch)
	{
		...
		fontCache.setColor(1, 1, 1, 0.2f);
		fontCache.draw(batch, cacheText, this.x, this.y);
